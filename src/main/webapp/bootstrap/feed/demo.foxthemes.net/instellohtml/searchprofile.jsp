...
<div id="wrapper">
            ...
            <ul>
                <li class="active">
                    <a href="/post">
                        ...
                        <span> Search Result User </span> </a>
                </li>
                <li>
    ...
    <div class="main_content">
        ...
        <div class="container m-auto">
            ...
            <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-5"> Result Search User </h1>
                                ...
                                <div class="flex items-center justify-between py-3">
                                    ...
                                    <div class="flex flex-1 items-center space-x-4">
                                        ...
                                        <div class="flex flex-col">
                                            <span class="block capitalize font-semibold"> ${s.username} </span>
                                            <span class="block capitalize text-sm"> ${s.address} </span>
                                        </div>
                                    </div>
