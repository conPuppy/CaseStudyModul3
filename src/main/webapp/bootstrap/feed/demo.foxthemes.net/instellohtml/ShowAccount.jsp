...
<div id="wrapper">
    ...
    <div class="main_content">
        ...
        <div class="container m-auto">
                            ...
                            <div class="market-list">
                                ...
                                <div class="item-media">
                                    <div type="" class="btn btn-info btn-lg" data-toggle="modal"
                                         data-target="#myModal${p.idaccount}"><img
                                            src="${p.avatarurl}"
                                            alt=""></div>
                                </div>
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-title">
                                        <div class="item-price"><a>${p.username}</a>
                                            &emsp;
                                        </div>
                                    </div>
                        ...
                        <c:forEach var="A" items="${A}">
                            <li>
                                ...
                                <div class="market-list">
                                    &emsp;
                                    <div class="item-media">
                                        <a type="button" href="/ShowOne?id=${A.idaccount}"> <img
                                                src="${A.avatarurl}"
                                                alt=""> </a>
                                    </div>
                                    ...
                                    <div class="item-inner">
                                        ...
                                        <div class="item-title">
                                            <div class="item-price"><a>${A.username}</a>
                                                &emsp;
                                            </div>
                                        </div>
                                        <div class="item-statistic">
            ...
            <%--</div>div--%>
            <c:forEach var="p" items="${ListAccount}">
            <div class="modal fade" id="myModal${p.idaccount}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="">
                            ...
                            <a type="button" href="/ShowOne?id=${p.idaccount}">Account</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a type="button" href="/showpostbyusername?idaccounts=${p.idaccount}">Post</a>
