    ...
    <div class="sidebar">
        ...
        <div class="sidebar_inner" data-simplebar>
            <div class="flex flex-col items-center my-6 uk-visible@s">
                ...
                <a href="/myposts" class="text-xl font-medium capitalize mt-4 uk-link-reset">
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="/setting"> Account setting </a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="header_inner">
              ...
              <div class="flex flex-col choose-upload text-center">
                ...
                <%--                                </div>--%>
                                ...
                                <p class="my-3 leading-6"> Do you have a picture wants to share us <br>
                                    please enter link...
                                </p>

                                <div uk-form-custom>
                                    <form class="uk-grid-small" uk-grid method="post"
                                          action="/createpost?idaccount=${account.idaccount}">
                                        ...
                                        <button class="button soft-warning small" type="submit"> Enter link image
                                        </button>
                                    </form>
                        ...
                        <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                            ...
                            <div class="flex justify-between items-center px-4 py-3">
                                <div class="flex flex-1 items-center space-x-4">
                                    ...
                                    <span class="block capitalize font-semibold dark:text-gray-100"> ${post.username} </span>
                                </div>
                                <div>
                                    <a href="#"> <i
                    ...
                    <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                        ...
                        <div uk-lightbox>
                            <div class="grid grid-cols-2 gap-2 p-2">
                                ...
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img9.jpg"
                                   class="col-span-2">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img9.jpg"
                                ...
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img10.jpg">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img10.jpg"
                                         alt="" class="rounded-md w-full h-full">
                                </a>
                                <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img11.jpg"
                                   class="relative">
                                    <img src="/bootstrap/feed/demo.foxthemes.net/instellohtml/assets/images/post/img11.jpg"
                                         alt="" class="rounded-md w-full h-full">
