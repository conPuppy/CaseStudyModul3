...
<div id="wrapper">
  ...
  <div class="sidebar">
    ...
    <div class="sidebar_inner" data-simplebar>
      <div class="flex flex-col items-center my-6 uk-visible@s">
        ...
        <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/profile.jsp" class="text-xl font-medium capitalize mt-4 uk-link-reset"> Admin
        </a>
  ...
  <div class="main_content">
    ...
    <div class="container m-auto">
      ...
      <h1 class="lg:text-2xl text-lg font-extrabold leading-none text-gray-900 tracking-tight mb-2"> Account Management </h1>
      ...
      <div class="lg:m-0 -mx-5 flex justify-between py-4 relative space-x-3 uk-sticky dark-tabs" uk-sticky="cls-active: bg-gray-100 bg-opacity-95" style="">
        <div class="flex overflow-x-scroll lg:overflow-hidden lg:pl-0 pl-5 space-x-3">
          <a href="/TopLike" class="bg-white py-2 px-4 rounded inline-block font-bold shadow"> Top Like</a>
          <a href="/TopFollow" class="bg-white py-2 px-4 rounded inline-block font-bold shadow"> Top Followers </a>

        </div>
        <%--                <a href="#"  uk-toggle="target: #offcanvas-create" class="bg-pink-500 hover:bg-pink-600 hover:text-white flex font-bold inline-block items-center px-4 py-2 rounded shadow text-white lg:block hidden"> <i class="-mb-1 mr-1 uil-plus"></i></a>--%>
      </div>
          ...
          <ul class="uk-slider-items uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid">
            ...
            <li>
              ...
              <div class="item-media" >
                <a type="button" href="/ShowOne?id=${C.getIdAccounts()}"> <img
                        src="${C.getAvatarurl()}"
                        alt=""> </a>
              </div>

              <div class="item-inner">
                <div class="item-price"> <a>${C.getUsername()}</a> </div>
                <div class="item-title"> Số lượt Like : &nbsp; <a>${C.getLikecount()}</a> </div>
